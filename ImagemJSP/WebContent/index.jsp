	...
	<form action="controllerImagem" id="formImagem"
		...
		<div style="width: 100%">
			...
			<div style="float: right; width: 45%;">
				<img src="<c:out value="${imagem.urlimagem}"/>" width="50%"	style="min-height: 250px;" border="0" id="target" name="target">
					<br />
					<input type="button" value="Excluir imagem" onclick="deletaFoto();">
					 <input	onchange="visualizarImg();" type="file" value="Selecionar a imagem">
			</div>
		</div>
